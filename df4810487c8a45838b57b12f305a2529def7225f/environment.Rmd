...
Important note: RStudio became Posit in October 2022 for better 'embracing multi-lingual data science' - such as Python lnaguage that you can use in RStudio. Explore it [here]<https://posit.co/> and follo the transition. 
