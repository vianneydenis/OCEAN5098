...
<p class="alert">
**`r knitr::asis_output("\U26A0")` Practice 1:** The data set `rairuoho` is available at the following [link](https://www.dipintothereef.com/uploads/3/7/3/5/37359245/rairuoho.txt). It provides 8 days length data of Easter grass exposed to different treatments.
