...
If this is not clear, check [this video](https://www.youtube.com/watch?v=zHbxbb2ye3E) with an example with playing cards.
...
<p class="comment">
**Practice M4:** Using environmental dataset `carp.chemistry` from Carpathian wetland (mainly chemistry): (1)  remove the variable slope, which is not a chemical variable; (2) perform a PCA, and evaluate importance of ordination axes using the broken stick criterion; (3) make a biplots using scaling=1 and scaling 2 then interpret results; (4)  repeat the same for the species data associates. 
</p>
