...
The original `iris` data set is a data frame of dimensions (`dim(iris)`) 150 observations by 5 vraiables. The function `summarise` summarise it into a data frame composed of 1 observation by 1 variable (the `mean(Sepal.width)`).
