...
We will go through this important section over the next **2 weeks**. 
...
Our correlation derived from a simple __linear regression__. It is used to predict a quantitative outcome $y$ on the basis of one single predictor variable $x$. The goal is to build a mathematical model (or formula) that defines $y$ as a function of the $x$ variable.
