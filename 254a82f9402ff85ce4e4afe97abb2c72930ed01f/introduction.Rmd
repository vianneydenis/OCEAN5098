...
<p class="comment">
**Practice 2:** Download `reef_fish.xlsx`, save it in a working directory you dedicated for this course, and import it in R. Do the same after converting this `reef_fish` file into a `.txt` file.
</p>
...
<span style="color: red">**BEGINNER**</span> In order to understand its multiple advantages, simply go to *File>New File>R Markdown* in RStudio. Give your document a title `test`. Select *HTML* Output. **Knit** the document create, and save it as `test` to visualize it.The options `r knitr::asis_output("\U1F2699")` should allow you to 'Preview in Window' or to 'Preview in viewer Panel'. Try to modify and play with it with the information available in the cheat sheets you downloaded.  


<span style="color: red">**ADVANCED I**</span> On the top of this **Introduction** page, you can download a *Introduction.Rmd*. By knitting it in RStudio, you should be able to **render** this *.Rmd* as html page similar to the present webpage. In order for it to work you would have to: (1) install **ALL** the packages used in this *.Rmd* (`knitr`, `xfun`, `abc`, `vegan`, `readxl`, `formatR`) (2) make sure to have in your working directory a file called **Data** where you will have download `reef_fish.xlsx` and generate `reef_fish.txt`. 


<span style="color: red">**ADVANCED II**</span> This [repository](https://github.com/vianneydenis/OCEAN5098.git) available on GitHub is the working directory of the OCEAN5098.Rproj file and it contains all of the .Rmd, .html and data files used to review this course. While you can can individually download and render the .Rmd files. It is better to **fork** this repository to your GitHub account, then clone a copy of this forked repository (from your own Github account to your computer).


# Git & GitHub

You will need a bit of time to get use to it, but the best way to work with R is by using online repositories. You can first create an **account** on [GitHub](https://github.com/) and **create a first repository** that you will later use connected with  RStudio.
...
<p class="comment"> **Practice 3:** Try You best to complete **ADVANCED I** and **ADVANCED II**. It may be challenging at first but if you succeed you will have master important functionalities of the R environment  
</p>
